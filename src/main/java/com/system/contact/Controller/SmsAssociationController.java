...
//
//    @PostMapping
//    public ResponseEntity<SmsAssociation> createSmsAssociation(@RequestBody SmsAssociationDTO smsAssociationDTO) {
//        SmsAssociation createdAssociation = smsAssociationService.createSmsAssociation(smsAssociationDTO);
